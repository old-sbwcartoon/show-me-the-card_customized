	...
	<div class="menu-wrap">
		<nav class="menu">
			...
			<a href="/showmethecard/home.action" class="logo page-scroll waves-effect">Site Cards</a>
				...
				<a href="/showmethecard/evaluation/evaluationmain.action?cardNo=2&pageNo=1" class="page-scroll waves-effect"><i class="fa fa-fw fa-envelope-o"></i><span>Evaluation</span></a>
