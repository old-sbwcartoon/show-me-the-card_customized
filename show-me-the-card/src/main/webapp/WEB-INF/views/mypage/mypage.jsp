									...
									if ($('#fName').val() != "") {
										$.ajax({
											...
											data : {
												...
												fNo : $('#u_m_fNo').val(),
												fName : $('#u_fName').val(),
												secret : $('#u_myonoffswitch')
														.is(":checked")
											},
											dataType : 'json',
											success : function(data) {

												$('#folder_' + data.fNo).text(
														data.fName)
												$('#myonoffswitch').prop(
														"checked",
														$('#secret').is(
...
<body class="index">
	...
	<span id='folderpage'> <c:forEach var="folder"
			items="${ folders }">
			<button type="button" id="folder_${ folder.fNo }" class="folderbasic"
				...
				<img id="folderbasicimg" style="height: 100px" class="btn-img"
					src="/showmethecard/resources/images/cardpack.jpg"><input
					type="hidden" id="fNo" name="fNo" value=${ folder.fNo }><input
					type="hidden" id="secret" name="secret" value=${ folder.secret }>${ folder.fName }</button>
		</c:forEach>
	</span>
										...
										<div class="col-md-12 wow fadeInLeft" data-wow-duration="2s"
											...
											<div class="col-md-12 form-group waves-effect">
												<input type="hidden" id="mId" name="mId"
													value="${ loginuser.mId }"> <input type="hidden"
													id="m_fNo" name="m_fNo" value=""> <input
													type="text" class="form-control" placeholder="폴더이름"
										...
										<div class="modal-footer">
											<div id="buttondiv" class="col-lg-12 text-center">
												...
												<button type="button" id="cancel"
													class="btn btn-primary waves-effect" data-dismiss="modal">&nbsp;&nbsp;취소&nbsp;&nbsp;</button>
											</div>
									...
									<div class="row">
										<div class="col-md-12 wow fadeInLeft" data-wow-duration="2s"
											...
											<div class="col-md-12 form-group waves-effect">
												<input type="hidden" id="u_mId" name="mId"
													value="${ loginuser.mId }"> <input type="hidden"
													id="u_m_fNo" name="m_fNo" value=""> <input
													type="text" class="form-control" placeholder="폴더이름"
													id="u_fName" name="fName" required
													data-validation-required-message="Please enter your id.">
										...
										<div class="modal-footer">
											<div id="u_buttondiv" class="col-lg-12 text-center">
												...
												<button type="button" id="u_cancel"
													class="btn btn-primary waves-effect" data-dismiss="modal">&nbsp;&nbsp;취소&nbsp;&nbsp;</button>
												<button type="button" id="u_delete"
													class="btn btn-primary waves-effect" data-dismiss="modal"
													style="background-color: #b73333">&nbsp;&nbsp;삭제&nbsp;&nbsp;</button>
											</div>

											<div class="onoffswitch">
												<input type="checkbox" name="onoffswitch"
													class="onoffswitch-checkbox" id="u_myonoffswitch" checked><label
