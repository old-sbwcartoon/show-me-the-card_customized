...
public class Literal {
	...
	public static class ParseHtml {
		...
		public static class SortKeyword {
		...
		public static class Nlp {
			...
			public static class PosTag {
				...
				public static final String NOUN = "NN"; //명사(단수)
				public static final String NNS  = "NNS"; //명사(복수)
				public static final String NNP  = "NNP"; //고유명사(단수)
				public static final String NNPS = "NNPS"; //고유명사(복수)
				
				public static final String FOREIGN_WORD = "FW"; //외래어 + a misspelled word
				
//				public static final String JJ = "JJ"; //형용사
				
				public static final String VERB = "VB"; //동사
				public static final String VBD  = "VBD"; //과거동사
				public static final String VBG  = "VBG"; //동명사, 현재분사
				public static final String VBN  = "VBN"; //과거분사
				public static final String VBP  = "VBP"; //1인칭형식 동사
				public static final String VBZ  = "VBZ"; //3인칭단수형식 동사
